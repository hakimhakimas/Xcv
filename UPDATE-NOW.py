...
SM-Y608N
SM-C736V""".splitlines()
	ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/FB4A;FBAV/218.0.0.31.67;FBBV/13795649;FBDM/{density=2.5,width=1280,height=1920};FBLC/en_PK;FBCR/BASE;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/GT-I9500;FBSV/6.4.4;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
	return ua
